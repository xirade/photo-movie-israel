      ...
      orders: [
        {
          ...
          listprice: [
            ...
            },
            {
              ...
              price: 1800,
              description:
                "- Планирование маршрута и рекомендации по логистике и образу в разных локациях <br>- Продумываю идею съемки <br>- Съемка с квадрокоптера до 2 вылетов (по 20мин вылет), если есть разрешение на съемку в этом месте <br>- Фон хромакей при работе в студии <br>- Количество фотографий до 200шт <br>- Ретушь лучших фотографий до 50 штук <br>- Выезд со своим освещением <br>- Черно-белые дубли всех обработанных фотографий, если требуется <br>- Обработка в течении 30 дней.",
              visible: null,
            },
          ],
          image: {
        ...
        },
        {
          ...
          description:
            "Съемка с монтажом. Видеовизитка, рекламный ролик, контент для блогеров.",
          listprice: [
            {
              id: "1",
              name: "Single order",
            ...
            },
            {
              ...
              price: 4000,
              description:
                "Не менее 5 роликов за 3 месяца по 800₪ каждый",
              visible: null,
            },
          ],
          image: {
        ...
        },
        {
          ...
          listprice: [
            ...
            },
            {
              ...
              price: 1500,
              description:
                "- Рекомендации по созданию образа <br>- Длительность съемки до 2,5 часов <br>- Около 70 обработанных фотографий + остальные удачные кадры в цветокоррекции <br>- Ретушь до 10 кадров <br>- Фотоальбом 30×30 на 15 разворотов <br>- Использование профессионального света <br>- Наличие подарочного сертификата <br>- Обработка до 14 дней <br>- Каждые дополнительные полчаса +250 ₪",
              visible: null,
            },
          ],
          image: {
          ...
          listprice: [
            {
              ...
              price: 800,
              description:
                "- Ролик до 1 мин. <br>- Придумываю идеи <br>- Подбираю локации <br>- Составляю сценарии и раскадровки <br>- Квадрокоптер при необходимости",
              visible: true,
            },
            {
              id: "2",
              ...
              price: 1800,
              description:
                "- до 2,5 часов работы видеооператора <br>- Квадрокоптер при необходимости <br>- Делаю цветокоррекцию <br>- Подбираю музыку и озвучку <br>- Добавляю титры и визуальные эффекты <br>- Фильм до 15 мин",
              visible: true,
            },
          ],
          image: {
